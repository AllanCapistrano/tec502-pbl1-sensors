...
public class RandomNumbers {
    ...
    /**
     * Gera um número de ponto flutuante aleatório com base nos limites passados.
     * 
     * @param start float - Menor número que pode ser gerado.
     * @param end float - Maior número que pode ser gerado.
     * @return float
     */
     ...
     * @param end int - Maior número que pode ser gerado.
     * @return int
     */
